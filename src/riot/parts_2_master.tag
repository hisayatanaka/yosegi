<my_parts_2_master>
	...
	<div class="parts_2_master">Parts 2 Master</div>
	...
	<script>
		...
		this.on('mount', () => {
			...
			// Mount
			require('./parts_2_block_1.tag');
			riot.mount('#my_parts_2_block_1', 'my_parts_2_block_1', { inherit: classMain });
			require('./parts_2_block_2.tag');
			riot.mount('#my_parts_2_block_2', 'my_parts_2_block_2', { inherit: classMain });
		});
	</script>
</my_parts_2_master>
